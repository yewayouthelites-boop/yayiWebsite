...
var ed25519 = require("@noble/ed25519"), sha2_js = require("@noble/hashes/sha2.js");
...
function pemToEd25519Hex(pem) {
  return ed25519.etc.bytesToHex(pemToEd25519Bytes(pem));
}
...
function generateSignature(url, privateKey) {
  const urlBytes = new TextEncoder().encode(url), privateKeyBytes = ed25519.etc.hexToBytes(privateKey), signatureBytes = ed25519.sign(urlBytes, privateKeyBytes);
...
exports.pemToEd25519Bytes = pemToEd25519Bytes;
exports.pemToEd25519Hex = pemToEd25519Hex;
exports.signUrl = signUrl;
exports.urlWithSigningParams = urlWithSigningParams;
