...
declare function PortableText<B extends TypedObject = PortableTextBlock$1>({ value: input, components: componentOverrides, listNestingMode, onMissingComponent: missingComponentHandler }: PortableTextProps<B>): JSX.Element;
